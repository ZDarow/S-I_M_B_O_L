...
### Средний
1. Mermaid-схемы для `elektrika/8-5.md`
2. Print-friendly CSS
3. Бейджи статуса разделов

### Низкий (опционально)
1. Мок-данные для моментов затяжки (автотесты)
2. OBD-II PID-коды в разделе диагностики
3. API car-data для поиска
